...
<body>
    ...
    <!-- Float Chart js -->
    <script src="<?= BASE_URL; ?>/files/assets/pages/chart/float/jquery.flot.js"></script>
    <script src="<?= BASE_URL; ?>/files/assets/pages/chart/float/jquery.flot.categories.js"></script>
    <script src="<?= BASE_URL; ?>/files/assets/pages/chart/float/curvedLines.js"></script>
    <script src="<?= BASE_URL; ?>/files/assets/pages/chart/float/jquery.flot.tooltip.min.js"></script>
    <!-- Chartlist charts -->
    ...
    <script type="text/javascript" src="<?= BASE_URL; ?>/files/assets/pages/dashboard/custom-dashboard.min.js"></script>
